...
if (!createObject('modNamespace',array(
    'name' => 'commerce_slack',
    'path' => $componentPath.'/core/components/commerce_slack/',
    'assets_path' => $componentPath.'/assets/components/commerce_slack/',
),'name', false)) {
    echo "Error creating namespace commerce_slack.\n";
}

/* Path settings */
if (!createObject('modSystemSetting', array(
    'key' => 'commerce_slack.core_path',
    'value' => $componentPath.'/core/components/commerce_slack/',
    'xtype' => 'textfield',
    'namespace' => 'commerce_slack',
    'area' => 'Paths',
    'editedon' => time(),
), 'key', false)) {
    echo "Error creating commerce_slack.core_path setting.\n";
}

if (!createObject('modSystemSetting', array(
    'key' => 'commerce_slack.assets_path',
    'value' => $componentPath.'/assets/components/commerce_slack/',
    'xtype' => 'textfield',
    'namespace' => 'commerce_slack',
    'area' => 'Paths',
    'editedon' => time(),
), 'key', false)) {
    echo "Error creating commerce_slack.assets_path setting.\n";
}
...
$assetsUrl = "{$requestUri}assets/components/commerce_slack/";

if (!createObject('modSystemSetting', array(
    'key' => 'commerce_slack.assets_url',
    'value' => $assetsUrl,
    'xtype' => 'textfield',
    'namespace' => 'commerce_slack',
    'area' => 'Paths',
    ...
    echo "Error creating commerce_slack.assets_url setting.\n";
}
...
foreach ($settings as $key => $opts) {
    ...
    if (!createObject('modSystemSetting', array(
        ...
        echo "Error creating commerce_slack.".$key." setting.\n";
    }
}
...
include $componentPath . '/core/components/commerce_slack/vendor/autoload.php';

// Grab the path to our namespaced files
$modulePath = $componentPath . '/core/components/commerce_slack/src/Modules/';

// Instruct Commerce to load modules from our directory, providing the base namespace and module path twice
$commerce->loadModulesFromDirectory($modulePath, 'modmore\\Commerce_Slack\\Modules\\', $modulePath);
